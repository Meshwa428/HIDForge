#ifndef HIDFORGE_BLE_HID_H
#define HIDFORGE_BLE_HID_H
...
public:
    BleHid(String deviceName = "HIDForge", String deviceManufacturer = "HIDForge", uint8_t batteryLevel = 100);
